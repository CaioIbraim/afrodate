...
export function ProfilePhotoUpload({ 
  ...
  return (
    <div className={cn("flex flex-col items-center", className)}>
      <div className={cn(
        "relative rounded-full overflow-hidden border-2 border-[#1E1E1E]/50 flex items-center justify-center bg-white",
        sizes[size]
      )}>
        {preview ? (
          <>
          ...
          <UserCircle className={cn("text-[#1E1E1E]/70", sizes[size])} />
        )}

        <label className={cn(
          "absolute bottom-0 right-0 bg-gradient-to-r from-oraculo-cyan to-[#1E1E1E]",
