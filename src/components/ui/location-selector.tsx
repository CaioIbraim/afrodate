      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full justify-between bg-white border-[#00FFD1]/30 text-oraculo-dark hover:bg-white hover:text-[#00FFD1]"
          >
        ...
        <PopoverContent className="w-full p-0 bg-white border-[#00FFD1]/30">
              ...
              <CommandGroup className="max-h-64 overflow-y-auto">
                {popularLocations.map((location) => (
                  <CommandItem
                    ...
                    className="text-oraculo-dark hover:bg-[#00FFD1]/10"
                  >
                    <Check
                      className={cn(
                        "mr-2 h-4 w-4",
        ...
        <div className="flex flex-wrap gap-2">
          {selectedLocations.map((location) => {
            ...
            return (
              <Badge
                key={location}
                className="bg-[#00FFD1]/10 hover:bg-[#00FFD1]/20 text-[#00FFD1] border border-[#00FFD1]/30"
