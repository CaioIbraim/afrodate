...
export function SignupForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        render={({ field }) => (
          <div className="flex items-start space-x-2 pt-2">
            <Checkbox
              ...
              className="data-[state=checked]:bg-[#1E1E1E] data-[state=checked]:border-[#1E1E1E]"
            />
            <label htmlFor="acceptTerms" className="text-sm text-neutral-600 leading-tight">
              Eu concordo com os{" "}
              <Link href="/terms" className="text-[#1E1E1E] hover:text-oraculo-cyan font-semibold">
                Termos de Uso
              </Link>{" "}
              e{" "}
              <Link href="/privacy" className="text-[#1E1E1E] hover:text-oraculo-cyan font-semibold">
      ...
      <Button
        type="submit"
        className="w-full bg-gradient-to-r from-oraculo-cyan to-[#1E1E1E] text-white hover:opacity-90"
        disabled={isLoading}
      >
