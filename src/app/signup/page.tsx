      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <div className="auth-card w-full max-w-md">
            ...
            <h2 className="text-[#1E1E1E] hover:text-oraculo-cyan text-2xl font-bold mb-6 text-center">
              Criar uma conta
            </h2>
            ...
            <p className="mt-8 text-center text-neutral-600">
              Já tem uma conta?{" "}
              <a href="/login" className="text-[#1E1E1E] hover:text-oraculo-cyan font-semibold">
                Entrar
              </a>
            </p>
          </div>
