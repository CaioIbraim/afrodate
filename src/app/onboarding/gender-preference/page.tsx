        ...
        <div className="space-y-4">
          <div
            className={`profile-card p-4 cursor-pointer transition-all ${
              genderPreference === "HOMEM" ? "border-2 border-[#1E1E1E]" : "hover:border-[#1E1E1E]/50"
            }`}
            ...
            <div className="flex items-center">
              <div
                className={`w-6 h-6 rounded-full border-2 mr-3 flex items-center justify-center ${
                  genderPreference === "HOMEM" ? "border-[#1E1E1E] bg-[#1E1E1E]/10" : "border-oraculo-muted"
                }`}
              >
                {genderPreference === "HOMEM" && <div className="w-3 h-3 rounded-full bg-[#1E1E1E]" />}
              </div>
          ...
          <div
            className={`profile-card p-4 cursor-pointer transition-all ${
              genderPreference === "MULHER" ? "border-2 border-[#1E1E1E]" : "hover:border-[#1E1E1E]/50"
            }`}
          ...
          >
            <div className="flex items-center">
              <div
                className={`w-6 h-6 rounded-full border-2 mr-3 flex items-center justify-center ${
                  genderPreference === "MULHER" ? "border-[#1E1E1E] bg-[#1E1E1E]/10" : "border-oraculo-muted"
                }`}
              >
                {genderPreference === "MULHER" && <div className="w-3 h-3 rounded-full bg-[#1E1E1E]" />}
              </div>
          ...
          <div
            className={`profile-card p-4 cursor-pointer transition-all ${
              genderPreference === "TODOS" ? "border-2 border-[#1E1E1E]" : "hover:border-[#1E1E1E]/50"
            }`}
          ...
          >
            <div className="flex items-center">
              <div
                className={`w-6 h-6 rounded-full border-2 mr-3 flex items-center justify-center ${
                  genderPreference === "TODOS" ? "border-[#1E1E1E] bg-[#1E1E1E]/10" : "border-oraculo-muted"
                }`}
              >
                {genderPreference === "TODOS" && <div className="w-3 h-3 rounded-full bg-[#1E1E1E]" />}
              </div>
