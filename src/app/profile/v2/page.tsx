  ...
  return (
    <div className="min-h-screen bg-gray-100 px-4 py-6 flex items-center justify-center">
      ...
      <Card className="max-w-md w-full">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center bg-gradient-to-r from-oraculo-cyan to-[#1E1E1E] text-transparent bg-clip-text">
        ...
        <CardContent className="space-y-4">
          <Button
            ...
            className="w-full bg-gradient-to-r from-oraculo-cyan to-[#1E1E1E] text-white hover:opacity-90 rounded-full"
          ...
          {subscription && (
            <div className="mt-4">
              <h3 className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-oraculo-cyan to-[#1E1E1E]">
                Subscrição JSONB
              </h3>
