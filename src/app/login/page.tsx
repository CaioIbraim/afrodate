  ...
  useEffect(() => {
    if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY) {
      ...
      toast({
        ...
        description: "Algumas configurações não foram realizadas.",
        variant: "destructive",
      })
    }
  }, [toast])
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <div className="auth-card">
            ...
            <h2 className="text-oraculo-purple hover:text-oraculo-cyan text-2xl font-bold mb-6 text-center ">Entrar na Plataforma</h2>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <Link href="/reset-password" className="text-sm text-oraculo-purple hover:text-oraculo-cyan">
                    Esqueceu a senha?
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="social-button flex items-center justify-center bg-white border border-neutral-300 rounded-full shadow-sm hover:bg-neutral-50 p-3"
            ...
            <p className="mt-8 text-center text-neutral-600">
              Não tem uma conta?{" "}
              <Link href="/signup" className="text-oraculo-purple hover:text-oraculo-cyan font-semibold">
                Cadastre-se
              </Link>
            </p>
          </div>
