...
import { Loader2, Heart, User2Icon, MapPin, ArrowRight, MessageSquare, Sparkles, X, Filter } from "lucide-react";
                      ...
                      <div className="flex gap-2 mt-3">
                        ...
                        {!nearbyProfile.isMatch ? (
                          <>
                            ...
                            <Button
                              variant="outline"
                              className="flex-1 w-full text-red-500 border-red-500 hover:bg-red-500/10 rounded-lg py-5 text-xs sm:text-sm font-medium"
